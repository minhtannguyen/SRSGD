...
__all__ = ['momentumnet_v4_learned_scalar']
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, step_size=math.sqrt(2.0), momentum=math.sqrt(0.5)):
    ...
    def forward(self, invec):
        ...
        outx = outprex + (self.momentum**2) * (outprex - residualprex)
...
def momentumnet_v4_learned_scalar(**kwargs):
    """
