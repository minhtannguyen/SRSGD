...
__all__ = ['momentumnet_v5_learned_scalar']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        outx = residualx - (self.step_size**2)*out + (self.momentum**2) * (residualx - residualprex)
...
def momentumnet_v5_learned_scalar(**kwargs):
    """
