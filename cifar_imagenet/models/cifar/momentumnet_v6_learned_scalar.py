...
__all__ = ['momentumnet_v6_learned_scalar']
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, step_size=math.sqrt(2.0), momentum=0.0):
    ...
    def forward(self, invec):
        ...
        outprex = residualx - (self.step_size**2)*out
        outx = outprex + self.sigmoid(self.momentum) * (outprex - residualprex)
...
def momentumnet_v6_learned_scalar(**kwargs):
    """
