...
__all__ = ['momentumnet_v7_learned_scalar']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        outx = residualx - (self.step_size**2)*out + self.sigmoid(self.momentum) * (residualx - residualprex)
...
def momentumnet_v7_learned_scalar(**kwargs):
    """
