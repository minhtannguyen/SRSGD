...
__all__ = ['momentumnet_lookahead_learned_scalar_v2']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        if self.downsampleprex is not None:
            residualprex = self.downsampleprex(prex)
        
        outprex = residualx - self.step_size*out
        outx = outprex + self.momentum * (outprex - residualprex)
...
def momentumnet_lookahead_learned_scalar_v2(**kwargs):
    """
