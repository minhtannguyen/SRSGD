...
__all__ = ['momentumnet_restart_lookahead_vel_learned_vec_relu_mom']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        x = x + torch.clamp(self.momentum, min=0.0) * prex
        ...
        if self.downsample is not None:
            ...
            outprex = torch.clamp(self.momentum, min=0.0) * residualprex - self.step_size * out
...
def momentumnet_restart_lookahead_vel_learned_vec_relu_mom(**kwargs):
    """
