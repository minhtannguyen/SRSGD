...
__all__ = ['momentumnet_heavyball_vel_scheme4_learned_scalar']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        if self.downsample is not None:
            ...
            residualprex = self.downsample(residualprex)
            
        outprex = self.momentum * residualprex  + (1. - self.momentum) * out
...
def momentumnet_heavyball_vel_scheme4_learned_scalar(**kwargs):
    """
