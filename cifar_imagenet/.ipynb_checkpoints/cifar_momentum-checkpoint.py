...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='momentumnet',
                    choices=model_names,
...
# Momentum
parser.add_argument('--step-size', default=2.0, type=float, help='step size in momentum net')
parser.add_argument('--momentum-const', default=0.5, type=float, help='momentum in momentum net')
parser.add_argument('--momentum-const1', default=0.5, type=float, help='momentum1 in adam net')
parser.add_argument('--momentum-const2', default=0.5, type=float, help='momentum2 in adam net')
parser.add_argument('--restart-freq', default=1, type=int, metavar='rf',
                    help='restart frequency for momentum')
...
def main():
    ...
    elif args.arch.startswith('restart_momentumnet'):
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
                    step_size=args.step_size, 
    ...
    elif args.arch.startswith('adagradnet'):
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
                    step_size=args.step_size, 
    ...
    elif args.arch.startswith('rmspropnet'):
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
                    step_size=args.step_size, 
    ...
    elif args.arch.startswith('adamnet'):
        model = models.__dict__[args.arch](
                    num_classes=num_classes,
                    depth=args.depth,
                    step_size=args.step_size, 
                    momentum1=args.momentum_const1,
                    momentum2=args.momentum_const2,
                    block_name=args.block_name,
                    feature_vec=args.feature_vec
                )
