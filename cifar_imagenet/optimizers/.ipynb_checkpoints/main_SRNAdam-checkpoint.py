...
if __name__ == '__main__':
    ...
    optimizer = SRNAdam(net.parameters(), lr=0.001, iter_count=iter_count, restarting_iter=100) #100 done
    ...
    for epoch in xrange(nepoch):
        ...
        ########## New Stuffs for Restarting ##############
        if epoch == 80:
            optimizer = SRNAdam(net.parameters(), lr=0.0001, iter_count=iter_count, restarting_iter=500) #500 done
        elif epoch ==160:
            optimizer = SRNAdam(net.parameters(), lr=0.00001, iter_count=iter_count, restarting_iter=1000) #1000 done
        ###################################################
        '''
        if epoch == 80:
            #optimizer = SGD_Adaptive(net.parameters(), lr=0.01, weight_decay=5e-4, iter_count=iter_count, iter_total=2)#iter_total)
            optimizer = SGD(net.parameters(), lr=0.01, weight_decay=5e-4, iter_count=iter_count, restarting_iter=80)#iter_total) 2
        elif epoch == 120:
            optimizer = SGD(net.parameters(), lr=0.001, weight_decay=5e-4, iter_count=iter_count, restarting_iter=200)#iter_total) 3
        elif epoch == 160:
            optimizer = SGD(net.parameters(), lr=0.0001, weight_decay=5e-4, iter_count=iter_count, restarting_iter=500)#iter_total) 3
        elif epoch == 200:
            optimizer = SGD(net.parameters(), lr=0.00001, weight_decay=5e-4, iter_count=iter_count, restarting_iter=1000)#iter_total) 4
        '''
