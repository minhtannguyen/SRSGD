...
__all__ = ['momentumnet_learned_decayed_scalar']
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, step_size=2.0, momentum=0.5, decay=1.0):
...
class MomentumNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, step_size=2.0, momentum=0.5, decay=1.0):
        downsample = None
...
def momentumnet_learned_decayed_scalar(**kwargs):
    """
