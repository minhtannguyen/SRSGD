...
__all__ = ['momentumnet_learned_scalar_uniform']
...
class Bottleneck(nn.Module):
    ...
    def forward(self, invec):
        ...
        print(self.step_size.data)
        print(self.momentum.data)
...
class MomentumNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, step_size=Parameter(torch.tensor(2.0), requires_grad=True), momentum=Parameter(torch.tensor(0.5), requires_grad=True)):
        downsample = None
...
def momentumnet_learned_scalar_uniform(**kwargs):
    """
